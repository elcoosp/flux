...
//! SwiftUI and only returns a [`CodegenError`] when a construct cannot be
//! represented at all.

use flux_syntax::Span;
use thiserror::Error;

/// An error produced while generating SwiftUI from a lowered Flux program.

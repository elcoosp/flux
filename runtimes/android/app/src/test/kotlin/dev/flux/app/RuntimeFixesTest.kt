...
import dev.flux.app.vm.CapabilityImpl
import dev.flux.app.vm.CapabilityKey
...
class RuntimeFixesTest {
    ...
    fun `init frame with handler registers and runs on dispatch`() =
        runTest {
            ...
            val executor = FluxExecutor(tree, signals, transport, vmScope = scope, mainDispatcher = dispatcher)

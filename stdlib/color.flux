...
// top-level `Name.field = expr` form shown in §18.6; that form's grammar
// production is tracked in ADR stdlib-grammar-gaps (G1). The values
// themselves are fully within Appendix B (a 3-tuple variant constructor).
